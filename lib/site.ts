...
export const banners = [
  ...
  },
  {
    ...
    subtitle: "Suprema • Gold • Fachada • Linha 25 • Lambris",
...
export const featuredProducts = [
  { name: "Perfis para Esquadrias", desc: "Linhas completas para portas e janelas." },
  { name: "Acessórios", desc: "Roldanas, escovas, fechos, parafusos e mais." },
  { name: "Lambris", desc: "Revestimento moderno com acabamento premium." },
  { name: "Chapas e Cantoneiras", desc: "Soluções para indústria e serralheria." },
];
